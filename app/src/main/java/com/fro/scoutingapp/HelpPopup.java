...
public class HelpPopup extends LinearLayout {
    ...
    public void setRatio(float top, float bottom){
        helpText1.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, 0, top));
        helpText2.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, 0, bottom));
        helpImage.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, 0, 10-top));
    }
