 ...
 * </ul>
 */
public class RowThreeBoxes extends LinearLayout implements InterfaceMultiRow {
    // Declare variables
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        leftFlipper.setPadding(verticalChange, horizontalChange, Values.three_boxes_flipper_height, Values.three_boxes_flipper_width);
        middleFlipper.setPadding(verticalChange, horizontalChange, Values.three_boxes_flipper_height, Values.three_boxes_flipper_width);
        rightFlipper.setPadding(verticalChange, horizontalChange, Values.three_boxes_flipper_height, Values.three_boxes_flipper_width);
    ...
    public void createMultiCounter(String name, int maxValue, int position, int colorPattern, int incAmount1) {
        if (position == Values.left) {
            ...
            middleFlipper.createMultiCounter(name, maxValue, colorPattern, incAmount1);
            middleTextView.setLayoutParams( new LayoutParams(LayoutParams.MATCH_PARENT, 0,  1.0f));
            middleFlipper.setLayoutParams( new LayoutParams(LayoutParams.MATCH_PARENT, 0,  4.0f));
        }
    ...
    public void createMultiCounter(String name, int maxValue, int position, int colorPattern, int incAmount1, int incAmount2) {
        if (position == Values.left) {
            ...
            middleFlipper.createMultiCounter(name, maxValue, colorPattern, incAmount1, incAmount2);
            middleTextView.setLayoutParams( new LayoutParams(LayoutParams.MATCH_PARENT, 0,  1.0f));
            middleFlipper.setLayoutParams( new LayoutParams(LayoutParams.MATCH_PARENT, 0,  4.0f));
        }
        else if (position == Values.right) {
    ...
    public void createSlider(String name, int minValue, int maxValue, double stepValue, int position) {
        ...
        else if (position == Values.middle) {middleFlipper.createSlider(name, minValue, maxValue, stepValue);}
